...
export default function DocumentationPage() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['tts', 'stt', 'voice-clone', 'agents', 'audiobook', 'credits'];
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto lg:px-6 px-4">
          <div className="flex items-center lg:justify-between justify-between h-14">
            <div className="flex items-center">
              <button
                className='flex flex-row gap-2 lg:gap-3 items-center'
                onClick={() => router.push("/")}
              > 
              ...
              {navItems.map((item) => (
                <button
                  ...
                  className={`text-sm font-medium transition-colors ${
                    activeSection === item.id ? 'text-gray-900 underline' : 'text-gray-600 hover:text-gray-900'
                  }`}
                >
                  {item.label}
                </button>
                ...
                {navItems.map((item) => (
                  <button
                    ...
                    className={`block w-full text-left px-4 py-2 text-sm font-medium transition-colors ${
                      activeSection === item.id ? 'text-gray-900 bg-gray-50' : 'text-gray-600 hover:bg-gray-50'
                    }`}
                  >
                    {item.label}
                  </button>
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        ...
        {/* SECTION 3 & 4: TTS + STT (2 COLUMN LAYOUT) */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          
          {/* TTS COLUMN */}
          <div id="tts" className="scroll-mt-20">
            <h2 className="text-3xl font-bold text-gray-900 mb-4 pb-2 border-b
             border-gray-900 " style={{ fontFamily: 'Georgia, serif' }}>
              TEXT-TO-SPEECH
            </h2>
            
            {/* Image on LEFT, text wraps around */}
            <div className="mb-4">
              <div className="float-left mr-4 mb-2 w-48 h-32 bg-gradient-to-br
               from-blue-100 to-blue-200 rounded flex items-center justify-center">
              ...
              <p className="text-gray-800 leading-relaxed mb-3" style={{ fontFamily: 'Georgia, serif' }}>
                Transform written text into natural-sounding speech with our advanced Text-to-Speech engine.
                 Lyvo offers multiple voice options to bring your words to life.
              </p>
              
              <p className="text-gray-800 leading-relaxed mb-3" style={{ fontFamily: 'Georgia, serif' }}>
                Whether you're creating content, building accessibility features, or just want to hear your text read aloud,
                 our TTS system delivers high-quality, natural-sounding audio every time.
              </p>
            </div>
            ...
            <div className="space-y-3 text-gray-800" style={{ fontFamily: 'Georgia, serif' }}>
              ...
              <p><strong>Step 2:</strong> Select your preferred voice from the dropdown menu.
          ...
          <div id="stt" className="scroll-mt-20">
            ...
            {/* Image on RIGHT, text wraps around */}
            <div className="mb-4">
              ...
              <p className="text-gray-800 leading-relaxed mb-3" style={{ fontFamily: 'Georgia, serif' }}>
                Convert spoken words into accurate written text with our Speech-to-Text technology.
                  Lyvo delivers reliable transcription for meetings, interviews, lectures, and more.
              </p>
              
              <p className="text-gray-800 leading-relaxed mb-3" style={{ fontFamily: 'Georgia, serif' }}>
                Our dual-engine approach ensures you always get the best possible transcription, even in challenging audio conditions or with multiple speakers.
              </p>
            </div>
            ...
            <div className="space-y-3 text-gray-800" style={{ fontFamily: 'Georgia, serif' }}>
              ...
              <p><strong>Step 3:</strong> Click "Transcribe" and wait for processing. This typically takes 10-30 
              seconds depending on audio length.</p>
        ...
        {/* VOICE CLONE + AGENTS (2 COLUMN LAYOUT) */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          
          {/* VOICE CLONE COLUMN */}
          <div id="voice-clone" className="scroll-mt-20">
            <h2 className="text-3xl font-bold text-gray-900 mb-4 pb-2 border-b border-gray-900"
            ...
            {/* Image on RIGHT, text wraps around */}
            <div className="mb-4">
              <div className="float-right ml-4 mb-2 w-48 h-32 bg-gradient-to-br
               from-green-100 to-green-200 rounded flex items-center justify-center">
                <img src="/images/twins.jpg" className="w-48 h-32 rounded-sm" alt="Twin" />
              </div>
              
              <p className="text-gray-800 leading-relaxed mb-3" style={{ fontFamily: 'Georgia, serif' }}>
                Create a digital replica of any voice with stunning accuracy.
                 Our voice cloning technology captures the unique characteristics, tone,
                  and emotion of a person's voice, allowing you to generate speech that sounds remarkably human.
              </p>
              
              <p className="text-gray-800 leading-relaxed mb-3" style={{ fontFamily: 'Georgia, serif' }}>
                Perfect for content creators, podcasters, and businesses
                 looking to maintain consistent voice branding across all their audio content.
              </p>
            </div>
            ...
            <div className="space-y-3 text-gray-800" style={{ fontFamily: 'Georgia, serif' }}>
              ...
              <p><strong>Step 2:</strong> Upload a clear audio sample of the voice you want to clone.   
              For best results, use 10-20 seconds of high-quality audio with minimal or no background noise.</p>
              <p><strong>Step 3:</strong> Give your voice clone a memorable name (e.g., "Morgan Freeman Style", "Professional Narrator").</p>
              <p><strong>Step 4  <span className='text-green-600'>(optional):</span></strong>
              Give clone a Description (e.g. you are a tutor) 
              .</p>
              <p><strong>Step 5:</strong> Click "Create Clone" and wait 2-5 minutes for processing. The system analyzes
               vocal patterns, pitch, and tone.</p>
          ...
          <div id="agents" className="scroll-mt-20">
            ...
            <div className="mb-4">
              ...
              <p className="text-gray-800 leading-relaxed mb-3" style={{ fontFamily: 'Georgia, serif' }}>
                Build intelligent conversational AI agents . Create custom personalities,
                 set specific behaviors, and share your agents with the world through unique shareable links.
              </p>
              
              <p className="text-gray-800 leading-relaxed mb-3" style={{ fontFamily: 'Georgia, serif' }}>
                From customer support bots to creative writing assistants,
                 your agents can handle complex conversations while maintaining context and personality throughout interactions.
              </p>
            </div>
            ...
            <div className="space-y-3 text-gray-800" style={{ fontFamily: 'Georgia, serif' }}>
              ...
              <p><strong>Step 2:</strong> Define your agent's personality by writing a detailed system prompt or choose from our custom templates.
               Include tone, expertise, and behavioral guidelines.</p>
            ...
            <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3" style={{ fontFamily: 'Georgia, serif' }}>
              Agents Share And Links
            </h3>
            
            <ul className="list-disc list-inside space-y-2 text-gray-800" style={{ fontFamily: 'Georgia, serif' }}>
            <li><strong>Agent Link:</strong> go to lyvo agent page to see your agent click on the menu "CREATE SHARE LINK" look for your agent link copy
             the url use agent anytime without depending on lyvo.</li>
            ...
            {/* Avatar showcase */}
            <div className="mt-6 flex items-center space-x-3 p-4rounded">
        ...
        {/* SECTION 7: AUDIOBOOK (FULL WIDTH) */}
        <div id="audiobook" className="scroll-mt-20 mb-16">
          ...
          {/* Image on LEFT, text wraps around */}
          <div className="mb-4">
            <div className="float-left mr-6 mb-3 w-64 h-40 bg-gradient-to-br flex-col
             from-zinc-400 to-gray-400 rounded-lg flex items-center justify-center">
              <Icon icon="simple-icons:audiobookshelf" width="70" height="70"/>
              <p className='text-sm font-serif tracking-wide mt-4'>Audiobook</p>
            </div>
            
            <p className="text-gray-800 leading-relaxed mb-3 text-lg" style={{ fontFamily: 'Georgia, serif' }}>
              Transform your written content into professional audiobooks with our intelligent chunking system. Whether you're converting novels, blog posts, or educational materials, Lyvo's audiobook generator handles long-form content with ease, automatically breaking down text into manageable segments for optimal audio quality.
            </p>
            
            <p className="text-gray-800 leading-relaxed mb-3" style={{ fontFamily: 'Georgia, serif' }}>
              Our system intelligently processes large documents, respecting natural paragraph breaks and maintaining narrative flow. Each chunk is processed separately to ensure consistent quality throughout the entire audiobook, then seamlessly merged into a single high-quality audio file.
            </p>
            
            <p className="text-gray-800 leading-relaxed mb-3" style={{ fontFamily: 'Georgia, serif' }}>
              Perfect for authors, educators, content creators, and anyone looking to make their written content accessible in audio format. The background processing system means you can continue working while your audiobook is being generated.
            </p>
          </div>
        ...
        <div id="credits" className="scroll-mt-20 mb-16">
          ...
          <div className="mb-4">
            ...
            <p className="text-gray-800 leading-relaxed mb-3 text-lg" style={{ fontFamily: 'Georgia, serif' }}>
              Lyvo operates on a transparent credit-based system that gives you complete control over your spending. Every feature has a clear credit cost, and you only pay for what you use. No hidden fees, no surprise charges - just straightforward pricing that scales with your needs.
            </p>
            
            <p className="text-gray-800 leading-relaxed mb-3" style={{ fontFamily: 'Georgia, serif' }}>
              New users start with 1,000 free credits to explore all features.
               When you're ready for more, purchase credits at $1.03 per 1,000
                credits through our secure Flutterwave integration. Credits never expire, 
                and your account automatically upgrades to Tier 2 (premium) status with your first purchase.
                Credits don't expire you buy as much as you want use till it's finished.
              Credits are refiled after 1 month if you have less than 2 credits. on free tier. 
            </p>
            
            <p className="text-gray-800 leading-relaxed mb-3" style={{ fontFamily: 'Georgia, serif' }}>
              All transactions are protected with enterprise-grade security including amount validation,
               idempotent processing to prevent double-charging, and complete audit trails. 
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="text-gray-800" style={{ fontFamily: 'Georgia, serif' }}>
                    <tr className="border-b border-gray-200">
                      <td className="p-3">Text-to-Speech Generation</td>
                      <td className="text-right p-3">5 credits</td>
                    </tr>
                    <tr className="border-b border-gray-200 bg-gray-50">
                      <td className="p-3">Speech-to-Text Transcription</td>
                      <td className="text-right p-3">8 credits</td>
                    </tr>
                    <tr className="border-b border-gray-200">
                      <td className="p-3">Voice Clone Creation</td>
                      <td className="text-right p-3">100 credits</td>
                    </tr>
                    <tr className="border-b border-gray-200 bg-gray-50">
                      <td className="p-3">AI Agent Message</td>
                      <td className="text-right p-3">2 credits (additional 5 credits if voice enabled)</td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="p-3">Audiobook (per 1,000 words)</td>
                      <td className="text-right p-3">15 credits</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <div className="space-y-3 text-gray-800" style={{ fontFamily: 'Georgia, serif' }}>
                ...
                <p><strong>Step 2:</strong> Enter the amount in USD. The system automatically calculates credits
                 (must be exact multiples of $1.03).</p>
            ...
            <div>
              ...
              <div className="mt-4 flex items-start space-x-3 p-4 bg-gray-50 rounded">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700">All payments processed through Flutterwave with 
                    bank-level encryption. We never store your payment details.</p>
                </div>
              </div>
            </div>
          </div>
